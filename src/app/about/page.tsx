  ...
  return (
    <div className="min-h-screen flex flex-col bg-white font-[family-name:var(--font-dm-sans)]">
        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-8 lg:px-10 py-8 sm:py-12">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="https://whatsapp.com/channel/0029Vb8MT8c002THGmdgsd32" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700 hover:bg-emerald-100 transition-colors text-sm font-medium">
              ...
              <a href="https://web.facebook.com/profile.php?id=61592735245077" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-blue-50 border border-blue-200 text-blue-700 hover:bg-blue-100 transition-colors text-sm font-medium">
      ...
      <footer className="bg-[#0f1b3d] text-gray-300 mt-auto">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 text-center text-xs text-gray-500">
